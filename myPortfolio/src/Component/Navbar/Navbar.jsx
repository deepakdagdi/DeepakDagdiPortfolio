      ...
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <span className='text-[#8245ec]'>&lt;</span>
         <span className='text-white'>Deepak</span>
          <span className='text-[#8245ec]'>    </span>
           <span className='text-white'>Dagdi</span>
            <span className='text-[#8245ec]'>&gt;</span>
            </div>
            {/* {destop Menu} */}
            ...
            <div className='hidden  md:flex space-x-4'>
              <a
               href="https://github.com/deepakdagdi"
               target='_blank'
               ...
               >
                ...
                <a
               href="https://www.linkedin.com/in/deepakdagdi"
               target='_blank'
               rel='noopener noreferrer'
               className='text-gray-300 hover:text-[#8245ec]'
               >
            ...
            <ul className='flex flex-col items-center space-y-4 py-4 text-gray-300'>
              {
                ...
                menuItems.map((item)=>(
                  <li key={item.id} className={`cursor-pointer hover:text-white ${activeSection === item.id ?
                    "text-[#8245ec]" :""
                  }`}>
