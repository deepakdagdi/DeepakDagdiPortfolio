  ...
  return (
    <section id='work' className='py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans relative'>
      ...
      <div className='text-center mb-16'>
        ...
        <p className='text-gray-400 mt-4 text-lg font-semibold'>A showcase of the projects I have worked on, highlight my skils and experience in various technology</p>
      </div>
              ...
              <div className='lg:p-8 p-6'>
                ...
                className=' flex flex-wrap gap-2 mb-6'>
                  {selectProject.tags.map((tag,index)=>(
                    <span key={index}
              className=' bg-[#251f38] text-xs font-semibold text-purple-500 rounded-full px-2 py-1  mb-2'>
                {tag}
              </span>
                  ))}
                  </div>
